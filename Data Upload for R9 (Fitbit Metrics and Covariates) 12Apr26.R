...
#Note: this code is copied from upload data from the IBS study, but which contains the same covariates and activity levels of interest
#This explains why the dataset is labeled "Fitbit and IBS"
...
saveRDS(dataset_32338507_person_df, "R9_person_df.rds")
...
saveRDS(dataset_32338507_survey_df, "R9_survey_df.rds")
...
saveRDS(dataset_32338507_fitbit_heart_rate_summary_df, "R9_fitbit_heart_rate_summary_df.rds")
...
saveRDS(dataset_32338507_fitbit_heart_rate_level_df, "R9_fitbit_heart_rate_level_df.rds")
...
saveRDS(dataset_32338507_fitbit_activity_df, "R9_fitbit_activity_df.rds")
...
saveRDS(dataset_32338507_fitbit_sleep_daily_summary_df, "R9_fitbit_sleep_daily_summary_df.rds")
...
dataset_32338507_fitbit_sleep_level_sql <- paste("
    ...
    WHERE
        SAFE_CAST(sleep_level.is_main_sleep AS BOOL) IS TRUE
...
saveRDS(dataset_32338507_fitbit_sleep_level_df, "R9_fitbit_sleep_level_df.rds")
...
saveRDS(dataset_32338507_fitbit_device_df, "R9_fitbit_device_df.rds")
...
saveRDS(dataset_32338507_drug_df, "R9_drug_df.rds")
...
saveRDS(dataset_32338507_condition_df, "R9_condition_df.rds")
...
saveRDS(dataset_32338507_measurement_df, "R9_measurement_df.rds")