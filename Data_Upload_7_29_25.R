...
saveRDS(dataset_32338507_person_df, "dataset_32338507_person_df.rds")
...
saveRDS(dataset_32338507_survey_df, "dataset_32338507_survey_df.rds")
...
saveRDS(dataset_32338507_fitbit_heart_rate_summary_df, "dataset_32338507_fitbit_heart_rate_summary_df.rds")
...
saveRDS(dataset_32338507_fitbit_heart_rate_level_df, "dataset_32338507_fitbit_heart_rate_level_df.rds")
...
saveRDS(dataset_32338507_fitbit_activity_df, "dataset_32338507_fitbit_activity_df.rds")
...
saveRDS(dataset_32338507_fitbit_sleep_daily_summary_df, "dataset_32338507_fitbit_sleep_daily_summary_df.rds")
...
saveRDS(dataset_32338507_fitbit_device_df, "dataset_32338507_fitbit_device_df.rds")
                ...
                JOIN
                    ...
                    JOIN
                        ...
                        FROM
                            `cb_criteria` cr             
                        WHERE
                            concept_id IN (21601664, 21601765, 21604490, 21604565, 21604600, 21604635, 21604653, 21604658, 21604661, 21604686, 21604753)             
...
saveRDS(dataset_32338507_condition_df, "dataset_32338507_condition_df.rds")
...
saveRDS(dataset_32338507_measurement_df, "dataset_32338507_measurement_df.rds")