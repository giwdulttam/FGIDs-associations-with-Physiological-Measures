...
# Shared modeling + manuscript-output engine (sourced up front).
...
# ==============================================================================
# Both phenotypes x both case definitions, anchored on the EARLIEST Fitbit date
# across the sleep and activity streams.
...
final_analysis_activity_sleep_gerd_df <- apply_primary_outcome_def(final_analysis_activity_sleep_gerd_df)
...
str(combined_results$gerd$diagnostics)
